...
class main(tk.Tk):
    ...
    def download(self):
        ...
        self.consolo.geometry('360x140')
        m_text = tkinter.Text(self.consolo, width=48, height=9)
        m_text.pack()
        # initialize the downloader
        downloader = NH_downLoader(self.var_address.get(), self.var_url.get(), m_text)
        downloader.start()
        self.var_url.set("")
        # display
