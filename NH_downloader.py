...
class NH_downLoader(threading.Thread):
    ...
    def downloadManga(self, target, address):
        try:
            ...
            return
        if not path: return
        self.print("\n__________________Downloading__________________\n\n" + title + "....\n")
        self.download_pages(target, path, length)
        self.print("\n\n__________________Finishied__________________\n\n")

    # create a new directory for manga
